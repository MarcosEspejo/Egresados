        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <a href="{{ route('home') }}" class="text-2xl font-bold flex items-center">
                    ...
                    <span class="hidden md:inline text-libertadores-green">SELL</span>
                </a>
                <div class="hidden md:flex space-x-6 items-center">
                    <a href="{{ route('home') }}" class="text-gray-700 hover:text-libertadores-green transition duration-300">Inicio</a>
                    <a href="{{ route('egresados.index') }}" class="text-gray-700 hover:text-libertadores-green transition duration-300">Directorio</a>
                    ...
                    <div class="relative group">
                        <button class="text-gray-700 hover:text-libertadores-green transition duration-300 flex items-center" id="login-button">
                            Iniciar Sesión
                            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg hidden" id="login-dropdown">
                            <a href="{{ route('egresados.login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Egresado</a>
                            <a href="{{ route('jefe_egresados.login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Jefe de Egresados</a>
                        </div>
                    </div>
                </div>
